<template>
  <div>
    <!-- <th:block
      th:replace="~{common/fragments/header :: headerFragment}"
    ></th:block>
    <div class="profile-container">
      <th:block
        th:replace="~{common/fragments/userHeader :: userHeaderFragment}"
      ></th:block>
    </div> -->
    <!-- 사이드바 추가 -->
        ...
        >
          ...
          <div class="profile-management-content">
            ...
            <div class="info-group1">
              ...
              <!-- <div class="error" th:if="${#fields.hasErrors('userName')}" >이름 오류</div> -->
            </div>
          ...
          <div class="button-group">
            <button
              type="button"
              class="btn-cancel"
              onclick="window.location.href='/mypage/userinfo'"
            >
              취소하기
            </button>
