      ...
      <tbody>
        <tr v-for="review in reviews" :key="review.reviewId">
          <td>
            ...
            <img :src="review.thumbnailUrl || '/images/placeholder.png'" alt="상품/코디 이미지" class="product-thumbnail" @click="navigateToDetail(review)"/>
            <div class="product-detail">
              <p class="brand-name">{{ review.brandName || ''}}</p>
              <p class="product-name">{{ review.productId ? review.productName : review.codiDescription  }}</p>
            </div>
          </div>
          </td>
